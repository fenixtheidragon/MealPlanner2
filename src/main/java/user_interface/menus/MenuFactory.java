...
public class MenuFactory {
    ...
    public Menu getMenu(MenuOption menu) {
        return switch (menu) {
            case MAIN_MENU -> new MainMenu(MenuOption.MAIN_MENU.getName(), new ArrayList<>(MenuOption.getMainMenuOptions()), scanner);
            case MEAL_MENU -> new MealMenu(MenuOption.MEAL_MENU.getName(), new ArrayList<>(MenuOption.getMealMenuOptions()), scanner);
            case WEEKLY_PLAN_MENU -> new WeeklyPlanMenu(MenuOption.WEEKLY_PLAN_MENU.getName(), new ArrayList<>(MenuOption.getWeeklyPlanMenuOptions()), scanner);
